...
export default class TabAliment extends Component {
    ...
    componentDidMount() {
        ...
        axios.get(url1).then(res => {
            ...
            this.setState({ alimento: alimento })
                ...
                <tbody>
                    {this.state.alimento.map(alimento => (
                        <tr>
                            ...
                            <td><span><button onClick={this.handleEdit.bind(this,alimento.id)} className="btn btn-warning btn-sm container-fluid"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-pencil" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
