        ...
        <div className="row">
            ...
            <div className="col-md-10 fondoGris offset-1 gap-up">
                <div className="btn btn-group btn-group-lg toggle container-fluid">
                    ...
                    <span><button className="btn btn-success btn-lg pull-right"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-plus" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
