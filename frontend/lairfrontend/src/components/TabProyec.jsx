                ...
                <tbody>
                    {proy.map(proyeccion => (
                        <tr >
                            ...
                            <td><span><button className="btn btn-danger btn-sm container-fluid" onClick={this.deleteProy(proyeccion.id)}><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-x" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
